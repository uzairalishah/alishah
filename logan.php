...
<body>
    <div class="full-screen-container">
      <div class="login-container">
        <h3 class="login-title">Logain Form</h3>
        <form  action="logan.php" method="Post">
         ...
         <button type="submit" name="Sub" class="login-button">login In</button>
        </form>
      </div>
     </div>
     <?php
 ...
 $conn = mysqli_connect("localhost","root","","logain");
     ...
     if(isset($_POST['username'])){
        ...
        $sq="select * from form where username='$username' and password='$password' ";
